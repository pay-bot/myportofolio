        ...
        {data.map((data, i) => (
          ...
          <div className={classnames(i % 2 === 0 ? "flex md:flex-row-reverse md:mb-20 mb-10 " : "flex md:mb-20 mb-10")}>
            <div className=" z-30 hover:md:z-0 hover:-z-10 md:w-7/12 w-11/12 md:relative absolute  ">
              <img src={data.img_url} alt="" className=" transform transition duration-500 ease-in-out md:hover:scale-110 hover:scale-0  rounded shadow-2xl md:h-[400px] h-[314px] " />
            </div>
            <div className={classnames(i % 2 === 0 ? "md:mr-1 mr-0 md:opacity-100 md:mt-5 opacity-0 transform transition duration-1000 ease-in-out hover:opacity-100 select-none md:w-5/12 w-full md:z-30 z-0 hover:z-30 relative md:px-0 px-3 md:py-0 pt-2  dark:md:bg-transparent dark:bg-gray-700 dark:bg-opacity-90 bg-white bg-opacity-80 md:bg-opacity-0 rounded" : "md:mr-1 mr-0 md:opacity-100 md:mt-5 opacity-0 transform transition duration-1000 ease-in-out hover:opacity-100 select-none md:w-5/12 w-full md:z-30 z-0 hover:z-30 relative md:px-0 px-3 md:py-0 pt-2  dark:md:bg-transparent dark:bg-gray-700 dark:bg-opacity-90 bg-white bg-opacity-80 md:bg-opacity-0 rounded ")}
            >
              ...
              <div className={classnames(i % 2 === 0 ? "-bottom-8 md:mt-0 mt-36 md:bottom-20 flex justify-start   md:absolute relative" : "-bottom-8 md:mt-0 mt-36 md:bottom-20 flex justify-start right-0  flex-row-reverse md:absolute relative ")}>
                {data.tech.map(data => <img src={data.code} className="w-8 h-8 mx-2 transform transition duration-500 ease-in-out hover:scale-125" alt="" />)}
