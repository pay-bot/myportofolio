...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="lg:w-9/12 w-11/12 flex md:flex-row flex-col my-auto lg:h-screen h-full items-center justify-center mx-auto px-4 md:-mt-20 mt-5 lg:overflow-hidden lg:-mb-2 mb-[88px]  ">
        <motion.div className="md:w-6/12 w-full mx-auto mb-5 "
          ...
          <div className="lg:text-left text-center lg:mt-24 ">
            ...
            <div className="mt-5 mb-5 text-4xl font-bold text-blue-500 md:text-left text-center">
              <Typewriter
                options={{
      ...
      <button className="bg-blue-100 px-4 py-2 text-lg font-semibold tracking-wider text-blue-600 rounded hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"  ><a href={RESUME}>{t("button.download")}</a></button>
        ...
        <motion.div className="md:w-6/12  relative w-full mx-auto flex md:flex-row justify-center flex-col lg:mt-14 mt-0 "
          ...
          <div className="rounded-full mx-auto relative lg:h-[400px] lg:w-[400px] h-[330px] w-[330px] px-5 border-4 border-green-500 hover:border-green-400  ">
            <img src="react-2.svg" alt="" className="ml-4 flex absolute animate-wiggle lg:w-20 w-16 h-16 lg:h-20 w-16 h-16 rounded-full p-2 nm-inset-white-100 dark:nm-inset-gray-100 " />
            <img src="vue.svg" alt="" className="right-8 flex absolute animate-wiggle lg:w-20 w-16 h-16 lg:h-20 w-16 h-16 rounded-full p-2 nm-inset-white-100 dark:nm-inset-gray-100 " />
            <img src="laravel.svg" alt="" className="lg:-ml-14 -ml-9 flex absolute animate-wiggle lg:w-20 w-16 h-16 lg:h-20 w-16 h-16 rounded-full p-2 mt-52 nm-inset-white-100 dark:nm-inset-gray-100 " />
            <img src="tailwind.svg" alt="" className="lg:-right-8 -right-3 flex absolute animate-wiggle lg:w-20 w-16 h-16 lg:h-20 w-16 h-16 rounded-full p-2 mt-52 nm-inset-white-100 dark:nm-inset-gray-100 " />
