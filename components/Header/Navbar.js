...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed z-50 w-full h-[80px]  bg-[#F4F4FB] dark:bg-[#2E3D60]   shadow-md">
        <div className="lg:w-9/12 w-11/12 flex mx-auto">
          ...
          >
            ...
            <button
              className="mt-6 h-8 z-50 px-2 border-2 border-blue-600 rounded bg-gray-500 dark:bg-white my-auto mr-3"
              type="button"
