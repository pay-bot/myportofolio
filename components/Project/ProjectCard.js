  ...
  return (
    <>
      <div className={clsx("flex md:mb-20 mb-10", rightShift && "flex-row-reverse")}>
        ...
        >
          <p className={clsx("capitalize mb-5 text-right text-xl font-semibold dark:md:text-gray-200 md:text-gray-700 text-black dark:text-gray-200 ", rightShift && "md:text-left text-right flex ")}>{judul}</p>
