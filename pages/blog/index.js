            ...
            <>
              <div className="lg:w-8/12 ">
                ...
                <div key={data.id} className="mt-5 border-b">
                  ...
                  <div
                    className="text-gray-700 md:block hidden dark:text-white truncate-3-lines line-clamp-3"
                  ...
                  >
                    <a className="">
                      <button
                        type="button"
                        className="text-white text-sm font-semibold p-2 my-6 bg-blue-400"
                      >
                        Lanjutkan Membaca
                      </button>
                    </a>
              ...
              <div className="lg:w-4/12 w-full mt-5">
                <div className="flex flex-col lg:ml-5">
                  <div className="border-b-2  border-black mb-5 flex">
                    <p className="text-md inline-block px-2 py-1 bg-black text-white">
                      RECENT POST
                    </p>
                  </div>
