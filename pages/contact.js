      ...
      <Wrapper>
        ...
        <div className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col mt-28 px-4">
          <div className="lg:w-6/12 w-full mr-5 ">
            <h2 className="font-semibold text-lg text-gary-700 dark:text-gray-300 mb-4">Message Us</h2>
            ...
            <p className="ml-10 mb-7 dark:text-gray-400 ">heldih19@yahoo.com</p>
          </div>
