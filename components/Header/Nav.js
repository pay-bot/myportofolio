...
export default function Nav({ dir }) {
  const dirs = {
    horizontal: "justify-center z-50 my-4 md:flex hidden lg:space-x-10 md:space-x-8",
    vertical: "flex flex-col z-50 text-center items-center space-y-16 justify-center text-3xl"
  }
