    ...
    <>
      <div className="flex mb-20">
        ...
        <div className="md:w-5/12 w-full relative md:mt-10 mt-0 md:px-0 md:py-0 pt-2 px-3  dark:md:bg-transparent bg-gray-700 dark:bg-gray-50 dark:bg-opacity-90 bg-opacity-90 md:bg-opacity-0 rounded z-30 ">
          ...
          <div className="text-right md:mt-20 mt-40 bottom-0 md:bottom-5 md:left-0  mb-5 flex dark:md:text-gray-200 md:text-gray-700 text-gray-200 dark:text-gray-600 text-lg font-semibold md:absolute relative justify-end">{tech}</div>
        </div>
